...
imageVersion="d20190828"

# NOTE: Dockerfile生成的镜像的文件名
imageFile="etcd_image.tar"
...
# NOTE: 服务程序的配置文件名称
programStartFlag="--config-file=$containerConfigPath/etcd.yml"
